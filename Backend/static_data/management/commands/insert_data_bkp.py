...
occurrence_list_A = [[2, 2, 1], [1, 1, 'NIL'], [2, 2, 1], [2, 2, 1], [2, 2, 1], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'],[3, 3, 2], [2, 2, 1], [2, 2, 1], [1, 1, 'NIL'], [2, 2, 1], [1, 1, 'NIL'],[1, 'NIL', 'NIL'],[1, 'NIL', 'NIL'],[1, 'NIL', 'NIL']]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'BKP',
                'station_penalty': 12839.09,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of BKP Station for 02 years (730 days).",
                'contract_by': "KHAGAUL LOCO LABOURS COPERATIVE SOCIETY LIMITED, JAI RAM BAZAR, KHAGAUL, PATNA, Patna, BIHAR-801105",
                'contract_no': "GEMC-511687735960336, Dated – 23-Aug-2022",
                'station_category': 'A',
                'is_hq': True
                }
            )
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(bkp).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(bkp).json')
