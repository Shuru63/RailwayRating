...
occurrence_list_A = [[2, 2, 1], [2, 2, 1], [2, 2, 1], [1, 1, 'NIL'], [2, 2, 1], [1, 1, 'NIL'], [2, 2, 1],[1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [2, 2, 'NIL'], [2, 2, 1], [3, 3, 2], ['NIL', 1, 1], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL']]
occurrence_list_B = [[1, 1, 'NIL'], [1, 1, 1], [1, 1, 1], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 1, 1]]
occurrence_list_C = [[2, 2, 1], [1, 1, 'NIL']]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'Ara',
                'station_penalty': 26595.39,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of ARA Station for 02 years (730 days)",
                'contract_by': "RELIABLE CONCRETE CORPORATION, 101, MARUTI PLAZA, DUMDUM COSSIPORE ROAD, HANUMAN MANDIR, NORTH 24 PARGANAS, WEST BENGAL-700074",
                'contract_no': "GEMC-511687709759097, Dated – 13-Sep-2022",
                'station_category': 'A',
                'is_hq': True
                }
            )
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(ara).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(ara).json')
