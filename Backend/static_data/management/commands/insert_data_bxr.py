...
occurrence_list_A = [[2, 2, 1], [1, 1, 'NIL'], [2, 2, 1], [2, 2, 1], [2, 2, 1], [2, 2, 1], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [3, 3, 2], [2, 2, 1], [1, 'NIL', 1], ['NIL', 'NIL', 1], [1, 1, 'NIL'], [1, 'NIL', "NIL"]]
occurrence_list_B = [[1, 1, 1], [1, 1, 'NIL'], [1, 1, 1], [1, 1, 1], [1, 'NIL', 1], [1, 1, 'NIL']]
occurrence_list_C = [[2, 1, 1], [1, 'NIL', 'NIL']]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'BXR',
                'station_penalty': 12900.34,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of BUXAR (BXR)  Station for 02 years (730 days).",
                'contract_by': "MOHAN KUMAR, HOUSE NO 14,NEW COLONY JAGARNATHPUR,DHURWA,DHURWA, Ranchi, JHARKHAND-834004",
                'contract_no': "GEMC-511687713399910, Dated – 18-Aug-2022",
                'station_category': 'A',
                'is_hq': True
                }
            )
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(bxr).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(bxr).json')
