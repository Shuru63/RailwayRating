...
occurrence_list_A = [[1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 1], [1, 'NIL', 'NIL'], [1, 1, 1], [2, 1, 1], [1, 1, 1], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL']]
occurrence_list_B = [[1, 1, 'NIL'], [1, "NIL", "NIL"], [1, 1, 'NIL']]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'KIUL',
                'station_penalty': 16432.37,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of KIUL Station for 02 years (730 days)",
                'contract_by': "NAVYOUVAK SANGH SARMIC SWABLAMBI SAHAKRI SAMITI, VILL SHOKHARA-2, PO BARAUNI, DISTT BEGUSARAI, BIHAR-851112",
                'contract_no': "GEMC-511687761360608, Dated - 23-12-2021",
                'station_category': 'A',
                'is_hq': True
                }
            )
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(kiul).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(kiul).json')
