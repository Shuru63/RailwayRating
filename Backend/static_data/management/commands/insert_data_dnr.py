...
occurrence_list_A = [[1, 'NIL', 'NIL'], [1, 1, 1], [1, 1, 1], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [2, 1, 'NIL'], [1, 1, 1], [2, 2, 1], [1, 1, 'NIL'], [2, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [2, 2, 1], [2, 2, 1], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL']]
occurrence_list_B = [[1, 1, 'NIL'], [1, 1, "NIL"]]
occurrence_list_C = [[1, 'NIL', 'NIL']]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'Dnapur',
                'station_penalty': 27175.97,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of DNR Station for 02 years (730 days)",
                'contract_by': "KHAGAUL LOCO LABOURS COPERATIVE SOCIETY LIMITED, JAI RAM BAZAR, KHAGAUL, PATNA, BIHAR-801105",
                'contract_no': "GEMC-511687777600778, Dated- 09-Dec-2021",
                'station_category': 'A',
                'is_hq': True
                }
            )
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(dnr).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(dnr).json')
