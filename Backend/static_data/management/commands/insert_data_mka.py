...
occurrence_list_A = [[1, 1, 'NIL'], [1, 1, 1], [1, 'NIL', 'NIL'], [1, 1, 1], [1, 1, 1], [1, 1, 1], [2, 1, 1], [1, 1, 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL'], [1, 'NIL', 'NIL']]
occurrence_list_B = [[1, 1, 1], [1, 1, 1]]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'Mokama',
                'station_penalty': 18279.36,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of MOKAMA (MKA) Station for 02 years (730 days)",
                'contract_by': "KHAGAUL LOCO LABOURS COPERATIVE SOCIETY LIMITED, JAI RAM BAZAR, KHAGAUL, PATNA, BIHAR - 801105",
                'contract_no': "GEMC-511687733070013, Dated – 10-Jan-2022",
                'station_category': 'A',
                'is_hq': True
                }
            )
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(mka).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(mka).json')
