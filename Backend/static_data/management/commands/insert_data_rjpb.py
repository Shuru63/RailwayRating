...
occurrence_list_A = [[2, 2, 1], [1, 1, 1], [1, 1, 'NIL'], [2, 5, 2], [2, 5, 1], [1, 'NIL', 'NIL'], [2, 2, 1], [2, 2, 1], [2, 1, 'NIL'], [2, 2, 1], [2, 2, 1], [2, 1, 'NIL'], [1, 'NIL', 'NIL'], [1, 1, 'NIL'], [1, 'NIL', 'NIL'], [2, 4, 1], [2, 4, 1], [2, 2, 1], [1, 1, 1], [2, 2, 1]]
occurrence_list_B = [[2, 3, 1], [1, 'NIL', 'NIL']]
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                'station_code': 103,
                'chi_id': 102,
                'station_zone': 'Rajendra Nagar Terminal',
                'station_penalty': 31776.27,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of Rajendra Nagar Terminal(RJPB) for 02 years (730 days)",
                'contract_by': "M/s. GANESH PRASAD SINGH H.O.- Sri Hari Niwas, Behind Narayani Tower, Hemunagar, Bilaspur(C.G.) 495004",
                'contract_no': "GEMC-5116877007850488, Dated-30-Mar-2022",
                'station_category': 'A',
                }
            )
            if created:
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(rjpb).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(rjpb).json')
            ...
            occurrences_list = occurrence_list_A + occurrence_list_B
            tasks_list = tasks_list_A + tasks_list_B
