    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            defaults={
                ...
                'chi_id': 102,
                'station_zone': 'PNBE',
                'station_penalty': 99029.52,
                'name_of_work': "Cleaning, Sanitation & Disinfection Services and Collection & Disposal of Waste Management Service of PNBE Station for 02 years (730 days).",
                'contract_by': "KHAGAUL LOCO LABOURS COPERATIVE SOCIETY LIMITED, JAI RAM BAZAR, KHAGAUL, PNBE, PNBE,BIHAR-801105",
                'contract_no': "GEMC-511687727784674, Dated 05-Aug-2022",
                'station_category': 'A1',
                }
            )
            if created:
            ...
            shifts = open('./static_data/management/commands/Stations(json)/shifts(pnbe).json')
            ...
            tasks = open('./static_data/management/commands/Stations(json)/tasks(pnbe).json')
